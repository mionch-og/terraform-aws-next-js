...
| lambda\_runtime | Lambda Function runtime | `string` | `"nodejs18.x"` | no |
...
| lambda\_functions | The map of ARNs mapped to the published version of the Lambda functions deployed. Can be used in a for\_each as needed. |
